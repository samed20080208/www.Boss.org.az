...
using www.Boss.org.az.Models.AutoMail;
using www.Boss.org.az.Models.Database;
using www.Boss.org.az.Models.Entity;
using www.Boss.org.az.Models.Exeptions;
using www.Boss.org.az.Models.Extentions;
using www.Boss.org.az.Models.JsonMethods;
...
namespace www.Boss.org.az.Models.Menu
{
    ...
    {
        public static void EmployerMenu(JsonDatabase db, Employer emp)
        {
                                        ...
                                        if (choise == 0)
                                        {
                                            ...
                                            else if (db.Workers.ToList().Exists(e => e.Cvs.Exists(v => v.Guid.ToString() == guid)))
                                            {
                                                ...
                                                if (emp.Vacancies != null)
                                                {
                                                    ...
                                                    {
                                                        Notification n = new() { Title = "New Vakansiya!", Text = "Your CV has been reviewed. I offer you a job!", FromUser = emp.Name + " " + emp.Surname, PostGuid = guid };
                                                            ...
                                                            TryView2:
                                                                ...
                                                                if (choise == 0)
                                                                {
                                                                    ...
                                                                    RetrySendVacancy:
                                                                        ...
                                                                        {
                                                                            Notification n = new() { Title = "New Vakansiya!", Text = "Your resume has been reviewed. I offer you a job!", FromUser = emp.Name + emp.Surname, PostGuid = guid };
                                                                            ...
                                                                            tempWorker.Notifications.Add(n);
                                                                            FileProcessJson.JsonFileWriteAllText("Workers.json", db.Workers);
                                                                            Thread.Sleep(1500);
                                                                            goto EmployerMenu;
                                                                        }
                            ...
                            RetryNotf:
                                ...
                                if (emp.Notifications.Exists(n => n.NotificationId == id))
                                {
                                    ...
                                    switch (choise)
                                    {
                                        case 0:
                                            {
                                                Notification n = new() { Title = "New notf by employer!", Text = "Congratulations, you have been accepted!", FromUser = emp.Name + " " + emp.Surname };
                                                worker.Cvs.Remove(worker.Cvs.Find(c => c.Guid.ToString() == guid));
                                                Console.Clear();
                                                Console.WriteLine($"The notification is sent to {worker.Name}...");
                                                worker.Notifications.Add(n);
                                                Network.SendNotf(emp, worker, n);
                                                break;
                                            }
                                        case 1:
                                            {
                                                Notification n = new() { Title = "New notf by employer!", Text = "Your terms do not match. Good luck for you!", FromUser = emp.Name + " " + emp.Surname };
                                                Console.Clear();
                                                Console.WriteLine($"The notification is sent to {worker.Name}...");
                                                worker.Notifications.Add(n);
                                                Network.SendNotf(emp, worker, n);
        ...
        private static Vacancy GetIncludeVacancyInfo(JsonDatabase db)
        {
            List<string> languages = new();
            Vacancy vacancy = new();
            String[] array = new String[db.Categories.ToList().Count];
